...
export const Gradient = () => {
  return (
    <>
      <div className="z-1 relative mx-2.5 h-6 rounded-b-[1.25rem] bg-[#1B1B2E] shadow-xl lg:mx-8 lg:h-6" />
      <div className="z-1 relative mx-6 h-6 rounded-b-[1.25rem] bg-[#1B1B2E]/70 shadow-xl lg:mx-20 lg:h-6" />
    </>
  );
};
...
export const BottomLine = () => {
  return (
    <>
      <div className="h-0.25 pointer-events-none absolute left-10 right-10 top-[55.25rem] hidden bg-n-6 xl:block" />
